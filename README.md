...
- Minimize the distractions that are caused by maps where routes are overlayed on a geographically accurate depiction where roads have turns and switchbacks.
- Provide a list of stops with helpful information that includes the routes that access the stop, facilities (restorooms, water, etc.), and points of interest (trailheads, geographic features, etc.).
